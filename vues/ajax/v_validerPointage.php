...
if (isset($_POST['signature'])) {
	...
	$avecPlus = implode('+',$sansPlus);
         ...
         * @$idUser integer Identifiant de l'utilsateur connecté
        ...
        */
        ...
        if (isset($_SESSION["odaChef"])) {
            $clot = $pdo->cloturerBis($_SESSION["chantier"],$_SESSION["date"],$visa,$_SESSION["odaChef"]);
        }
        else{
            if($chef!=$idUser){
                $clot = $pdo->cloturerBis($_SESSION["chantier"],$_SESSION["date"],$visa,$idUser);
            }
            else{
                $clot = $pdo->cloturer($_SESSION["chantier"],$_SESSION["date"],$visa,$idUser);
            }
