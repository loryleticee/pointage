...
<br><br>
Nom du matériel:<input id='idMateriel' type="hidden" autocomplete="off" size="30"  name="idMateriel" value="<?php echo $group?>" />
...
Nom du loueur<input type="text" id="nomGroup" name="nomGroup" value="tapez le nom du loueur" onclick="this.value='';"size="30" maxlenght="60">
